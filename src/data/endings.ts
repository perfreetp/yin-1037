...
export const endings: Ending[] = [
  {
    ...
    unlockConditions: [
      { type: 'affection', target: 'lyra', value: 50, operator: '>=' },
      { type: 'affection', target: 'kairo', value: 50, operator: '>=' },
      { type: 'ending_unlocked', target: 'ending_good_1', value: true }
    ]
  },
  {
    id: 'ending_good_1',
    ...
    unlockConditions: [
      { type: 'affection', target: 'lyra', value: 30, operator: '>=' },
      { type: 'has_item', target: 'star_crystal', value: true }
    ]
  },
  {
    id: 'ending_good_2',
    ...
    unlockConditions: [
      { type: 'affection', target: 'kairo', value: 60, operator: '>=' },
      { type: 'choice_made', target: 'ch1_s3_c1', value: true }
    ]
  },
  {
    id: 'ending_neutral_1',
    ...
    thumbnail: '📬',
    cgImage: '📨',
    storyText: '你完成了所有的投递任务，成为了一名合格的信使。但偶尔你会想，如果当时做出不同的选择，一切会不会不一样？',
    unlockConditions: [
  ...
  },
  {
    ...
    unlockConditions: [
      { type: 'affection', target: 'seraphine', value: 40, operator: '>=' },
      { type: 'trust', target: 'seraphine', value: 30, operator: '>=' }
    ]
  }
];
